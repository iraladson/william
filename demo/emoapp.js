...
EMOAPP.Belief = function(){
    ...
    this.getAppraisalVariables = function(){
        ...
        if(recentBelief && recentBelief.subject == "self"){
            var mod0 = {};
            mod0.id = "surprise";
            mod0.val = 0.6;
        ...
        } else if(recentBelief && recentBelief.subject == "other") { 
            var mod0 = {};
            mod0.id = "surprise";
            mod0.val = 0.3;
        ...
        } else if (recentBelief && recentBelief.subject) {
            var mod0 = {};
            mod0.id = "surprise";
            mod0.val = 0.7;
...
function getSentiment(sentence){
    ...
    function tokenizeInput(text){
       ...
       var sentiment = 0;
        ...
        var returnVal = (sentiment/(result.length - factorsToIgnore)) * factor;
